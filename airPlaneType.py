...
def getAirPlanesTypes():
    return {
        "albatros": AirPlaneType("albatros", "textures/gameplay/albatros.png", 80, 80, 60, 20, 0.2),
        "fokker": AirPlaneType("fokker", "textures/gameplay/fokker.png", 80, 80, 50, 10, 0.15),
        "sopwith": AirPlaneType("sopwith", "textures/gameplay/sopwith.png", 80, 80, 40, 50, 0.1),
        "spad": AirPlaneType("spad", "textures/gameplay/spad.png", 80, 80, 100, 5, 0.02)
    }
